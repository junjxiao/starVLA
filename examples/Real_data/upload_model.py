import os
os.environ['MODELSCOPE_API_TOKEN']='ms-2a598c94-4a36-47d1-a8a5-79406818aa4d'
...
# 配置
SRC_DIR = Path("/mnt/workspace/junjin/code/starVLA/checkpoints/0128_real_put_toy_in_cabinet_Qwen3vlGR00T_vggt_cross_bs8")                     # 原始模型目录
TARGET_MODEL_FILE = "steps_3000_pytorch_model.py" # 你要保留的模型文件名
repo_id = "junjxiao/starvla_put_toy_in_cabinet_3000"
...
api.upload_folder(
repo_id=repo_id,
folder_path='/mnt/workspace/junjin/code/starVLA/checkpoints/tmp',
