...
args="--config_yaml ./examples/LIBERO/train_files/starvla_cotrain_libero.yaml \
      ...
      --datasets.vla_data.data_mix libero_10_depth \
      --datasets.vla_data.per_device_batch_size 16 \
      --trainer.vla_data.video_backend torchvision_av \
      --trainer.freeze_modules 'qwen_vl_interface.model,spatial_model,fuser,spatial_projector,action_model,image_edit_model,image_edit_projector,spatial_fuser,view_selector,spatial_fuser2' \
